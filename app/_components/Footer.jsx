        ...
        <footer className="bg-gray-100 ">
            <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="flex justify-center text-teal-600">
                    <div className='flex flex-row justify-center items-center gap-0'><Image src="/shopping-bag.png" alt='bag' width={75} height={60} /> <h1 className='flex flex-col leading-7 text-[35px] font-bold  text-[#CD7A3D] '>Grocery<span className='text-[#4C9B6D]'>Store</span></h1></div>
                </div>
